...
namespace Client.ServiceChat {
    ...
    public interface IServiceChat {
        ...
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/Send")]
        void Send(string message, int id);
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/Send")]
        System.Threading.Tasks.Task SendAsync(string message, int id);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceChatCallback {
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true, Action="http://tempuri.org/IServiceChat/SendCallback")]
    ...
    public partial class ServiceChatClient : System.ServiceModel.DuplexClientBase<Client.ServiceChat.IServiceChat>, Client.ServiceChat.IServiceChat {
        ...
        public void Send(string message, int id) {
            base.Channel.Send(message, id);
        }
        
        public System.Threading.Tasks.Task SendAsync(string message, int id) {
            return base.Channel.SendAsync(message, id);
        }
    }
}
